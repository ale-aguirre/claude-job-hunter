...
const _SENKU  = { name: 'Senku',   shortRole: 'Orchestrator', emoji: '🧪', color: '#f97316', avatar: '/avatars/senku.svg',      anime: 'Dr. Stone',   role: 'Orchestrator · analiza resultados y genera planes' };
...
const _MOB    = { name: 'Mob',     shortRole: 'Registration', emoji: '👻', color: '#7c3aed', avatar: '/avatars/mob.svg',        anime: 'Mob Psycho',  role: 'Registration · se registra en plataformas y valida emails' };
