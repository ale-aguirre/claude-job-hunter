...
const _MOB    = { name: 'Mob',     shortRole: 'Registration', emoji: '👻', color: '#7c3aed', avatar: '/avatars/mob.png',        anime: 'Mob Psycho',  role: 'Registration · se registra en plataformas y valida emails' };
